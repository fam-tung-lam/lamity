...
object ModelCatalog {
    ...
    val seed: List<LlmModel> = listOf(
        LlmModel(
            id = "qwen2.5-1.5b-instruct-q8",
            name = "Qwen2.5 1.5B Instruct",
            description = "Solid all-round chat model with good tool-calling support. " +
        ...
        LlmModel(
            ...
            name = "Gemma 3 1B IT",
            description = "Google's compact Gemma 3 instruction-tuned model, int4. " +
        ...
        LlmModel(
            id = "gemma-4-e2b-it",
            name = "Gemma 4 E2B (2B)",
            description = "Google's Gemma 4 with 2B effective parameters. Strong quality and " +
        ...
        LlmModel(
            id = "gemma-4-e4b-it",
            name = "Gemma 4 E4B (4B)",
            description = "Google's Gemma 4 with 4B effective parameters. Excellent quality " +
        ...
        LlmModel(
            id = "gemma-4-12b-it",
            name = "Gemma 4 12B",
            description = "Google's largest on-device Gemma 4 — the strongest model in this " +
                "catalog. 6.5 GB download; only for flagship devices with 12 GB+ RAM. " +
                "No HuggingFace token required.",
            url = "https://huggingface.co/litert-community/gemma-4-12B-it-litert-lm/resolve/" +
        ...
        LlmModel(
            ...
            description = "Reasoning model that streams its thinking before answering. " +
                "Quantized to int8. No HuggingFace token required.",
            url = "https://huggingface.co/litert-community/DeepSeek-R1-Distill-Qwen-1.5B/resolve/" +
        ...
        LlmModel(
            ...
            name = "FunctionGemma 270M (actions)",
            description = "Tiny 270M Gemma fine-tuned for function calling demos. " +
                "Quick to download; weak at general chat. CPU only.",
            url = "https://huggingface.co/litert-community/functiongemma-270m-ft-mobile-actions/resolve/" +
                "38942192c9b723af836d489074823ff33d4a3e7a/mobile_actions_q8_ekv1024.litertlm?download=true",
            fileName = "functiongemma-270m-mobile-actions_q8.litertlm",
            sizeBytes = 288_964_608,
            requiresAuth = false,
